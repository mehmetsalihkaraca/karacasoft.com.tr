...
* **PWA (Progressive Web App):** `manifest.json` ve Service Worker desteği sayesinde internet bağlantısı kesilse bile web sitesi çalışmaya devam eder.
...
* **Backend:** PHP
* **Frontend:** HTML5, Boostrap5, CSS3, JavaScript
* **Kütüphaneler:** [Fuse.js](https://fusejs.io/) (Arama motoru için)
* **Dağıtım:** Hostinger Git Entegrasyonu & GitHub Webhooks

##  Kurulum ve Kullanım

1. Bu depoyu klonlayın:
   ```bash
   git clone [https://github.com/mehmetsalihkaraca/karacasoft.com.tr.git](https://github.com/mehmetsalihkaraca/karacasoft.com.tr.git)